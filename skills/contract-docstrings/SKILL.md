...
description: >-
  Write docstrings that document each function's contract. Identifies input invariants, errors raised on violation, errors from external state, and silenced errors from callees.
license: MIT
