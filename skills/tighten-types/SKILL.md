...
name: tighten-types
description: >-
  Analyze Python code and tighten type annotations. Finds missing attribute types, replaces loose dicts with Pydantic models, adds overloads, and removes redundant in-body annotations.
license: MIT
